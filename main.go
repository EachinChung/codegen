...
var (
	...
	trimPrefix = flag.String("trim-prefix", "", "trim the `prefix` from the generated constant names")
...
func main() {
	...
	if !*doc {
		...
		g.Printf("// Package code generated by \"codegen %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
...
func (g *Generator) generate(typeName string) {
	...
	g.Printf("\t// init register error codes defines in this source code to `github.com/EachinChung/errors`\n")
	g.Printf("func init() {\n")
